...
class StudentForgetScreen extends StatefulWidget {
 const StudentForgetScreen({super.key});

  @override
  State<StudentForgetScreen> createState() => _StudentForgetScreenState();
}

class _StudentForgetScreenState extends State<StudentForgetScreen> {
