...
import 'package:lionman_school_of_rewilding/screen/auth/signup/teacher_education_details.dart';
...
class TeacherBasicDetails extends StatefulWidget {
 const TeacherBasicDetails({super.key});

  @override
  State<TeacherBasicDetails> createState() => _TeacherBasicDetailsState();
}

class _TeacherBasicDetailsState extends State<TeacherBasicDetails> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SubmitButton(
                        ...
                        onPressed: () {
                          Get.to(() =>const TeacherEducationDetails());
                        },
                        text: 'Save & Next',
