...
import 'package:lionman_school_of_rewilding/screen/teacher_dashboard/teacherhome/teacher_edit_vedio_details.dart';
import 'package:lionman_school_of_rewilding/widgets/appbar.dart';
import 'package:video_player/video_player.dart';

class TeacherVideoDetails extends StatefulWidget {
 const TeacherVideoDetails({super.key});

  @override
  State<TeacherVideoDetails> createState() => _TeacherVideoDetailsState();
}

class _TeacherVideoDetailsState extends State<TeacherVideoDetails> {
                ...
                child: PreferredSize(
                  ...
                  child: CustomAppbar(
                      ...
                      actionWidget: PopupMenuButton<int>(
                        ...
                        onSelected: (result) {
                          if (result == 0) {
                            Get.to(() =>const TeacherEditVedioDetails());
                          }
                          if (result == 1) {
