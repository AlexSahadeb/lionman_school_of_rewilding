...
class TeacherEditVedioDetails extends StatefulWidget {
 const TeacherEditVedioDetails({super.key});

  @override
  State<TeacherEditVedioDetails> createState() => _TeacherEditVedioDetailsState();
}

class _TeacherEditVedioDetailsState extends State<TeacherEditVedioDetails> {
